...
VALUES ('alert-contract-below', 'alert-worker-below', 'L4P-2026', '2026-07-01 00:00:00.000000', 'Test Job', 5, 'test-key'),
       ('alert-contract-above', 'alert-worker-above', 'L4P-2026', '2026-08-01 00:00:00.000000', 'Test Job', 15, 'test-key');
